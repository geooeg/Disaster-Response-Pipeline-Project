...
def load_data(messages_filepath, categories_filepath):
    '''
    load data from CSV files, merge two data source and return the merged data as a DataFrame
    :param messages_filepath:  Filepath of messages csv file
    :param categories_filepath: Filepath of categories csv file
    :return: df - DataFrame of the merged data
    '''
...
def clean_data(df):
    ...
    2, Rename columns of categories with new column names.
    3, Remove duplicates
    4, Convert category values to just numbers 0 or 1
    :param df: DataFrame of the merged messages and categories data
...
def save_data(df, database_filename):
    ...
    :param database_filename: the name of the sqlite database
    :return:
    '''
